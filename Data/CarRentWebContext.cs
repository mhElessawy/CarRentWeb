...
namespace CarRentWeb.Data;
public partial class CarRentWebContext : DbContext
{
    public CarRentWebContext()
    {
    }

    public CarRentWebContext(DbContextOptions<CarRentWebContext> options)
        : base(options)
    {
    }
