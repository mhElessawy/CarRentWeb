...
namespace CarRentWeb.Controllers
{
    public class EmployeeTakeMoneysController : Controller
    {
        ...
        public EmployeeTakeMoneysController(CarRentWebContext context)
        {
            _context = context;
        }
        ...
        {
            TempData.Keep();
            var carRentWebContext = _context.EmployeeTakeMoney
                                .Include(e => e.TakeUser)
                                .Include(e => e.User)
                                .OrderByDescending(a=>a.TakeDate);
            return View(await carRentWebContext.ToListAsync());
        }
