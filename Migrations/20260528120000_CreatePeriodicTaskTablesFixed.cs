...
{
    /// <inheritdoc />
    public partial class CreatePeriodicTaskTablesFixed : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Drop if they somehow exist (from a partial or local migration)
            migrationBuilder.Sql(@"
                IF OBJECT_ID('dbo.PeriodicTaskInstanceStep', 'U') IS NOT NULL
                    DROP TABLE dbo.PeriodicTaskInstanceStep;
                IF OBJECT_ID('dbo.PeriodicTaskStep', 'U') IS NOT NULL
                    DROP TABLE dbo.PeriodicTaskStep;
                IF OBJECT_ID('dbo.PeriodicTaskInstance', 'U') IS NOT NULL
                    DROP TABLE dbo.PeriodicTaskInstance;
                IF OBJECT_ID('dbo.PeriodicTaskDef', 'U') IS NOT NULL
                    DROP TABLE dbo.PeriodicTaskDef;
            ");
